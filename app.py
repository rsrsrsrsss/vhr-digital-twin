...
# ==========================================================
    ...
    # ==========================================================
    # 🧪 ТОЧКА 1: МАТЕРИАЛ И ФИЗИКОХИМИЧНА СРЕДА (ХИМИЧЕСКИ АГРЕСОРИ)
    # ==========================================================
    st.subheader("🧪 1. Избор на материал и физикохимична среда (Химически агресори)")
    ...
    # ==========================================================
    # 📐 ТОЧКА 2: ГЕОМЕТРИЧНИ ПАРАМЕТРИ, НАЛЯГАНЕ И СМЕТКИ
    # ==========================================================
    st.markdown("---")
    ...
    # ⚙️ Физикохимични преизчисления за корозията (въз основа на химическите агресори от точка 1)
    if velocity < 0.2:
        flow_factor = 1.0
    elif velocity <= 2.5:
    ...
    # ==========================================================
    # 🎯 ТОЧКА 3: ПИТИНГОВА КОРОЗИЯ И КИНЕТИКА
    # ==========================================================
    st.markdown("---")
    ...
    # ==========================================================
    # 📋 ТОЧКА 4: ИНЖЕНЕРНА СПЕЦИФИКАЦИЯ И ПРЕДПИСАНИЕ
    # ==========================================================
    st.markdown("---")
