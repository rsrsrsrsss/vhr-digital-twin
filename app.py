...
st.title("Интерактивен Дигитален двойник на ВХР — енергоблок 5 (ВВЕР-1000)")
...
# ==========================================================
    ...
    with st.expander(f"Подробна техническа & оперативна характеристика за: {metal}", expanded=True):
